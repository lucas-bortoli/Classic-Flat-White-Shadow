...
# create montage
montage -geometry +0+0 -tile 5x ./stage1/{arrow0,left_ptr_watch0,grab0,watch0,X_cursor0,right_side0,based_arrow_down0,bottom_left_corner0,bottom_right_corner0,center_ptr0,cross0,fleur0,question_arrow0,xterm0}.png montage.png
